...
IDE_Morph.prototype.setDefaultDesign = function() {
  ...
  SpriteMorph.prototype.sliderColor = SpriteMorph.prototype.paletteColor.lighter(
    30
  );
  ...
  IDE_Morph.prototype.groupColor = SpriteMorph.prototype.paletteColor.lighter(
    8
  );
...
IDE_Morph.prototype.openIn = function(world) {
  ...
  function interpretUrlAnchors() {
    ...
    if (location.hash.substr(0, 6) === '#open:') {
      ...
      if (
        contains(
          ['project', 'blocks', 'sprites', 'snapdata'].map(function(each) {
...
IDE_Morph.prototype.createControlBar = function() {
  ...
  // cloudButton
  button = new PushButtonMorph(this, 'cloudMenu', new SymbolMorph('cloud', 11));
  button.corner = 12;
  button.color = colors[0];
  button.highlightColor = colors[1];
  button.pressColor = colors[2];
  ...
  this.controlBar.fixLayout = function() {
    ...
    [stopButton, pauseButton, startButton].forEach(function(button) {
...
IDE_Morph.prototype.createStage = function() {
  ...
  if (this.currentSprite instanceof SpriteMorph) {
    this.currentSprite.setPosition(
      this.stage.center().subtract(this.currentSprite.extent().divideBy(2))
    );
  ...
  function addRotationStyleButton(rotationStyle) {
    ...
    button = new ToggleButtonMorph(
      ...
      function() {
        // query
        return (
          myself.currentSprite instanceof SpriteMorph &&
          myself.currentSprite.rotationStyle === rotationStyle
        );
      },
      null, // environment
...
IDE_Morph.prototype.createCorralBar = function() {
  ...
  if (CamSnapshotDialogMorph.prototype.enableCamera) {
    ...
    document.addEventListener('cameraDisabled', function(event) {
      cambutton.disable();
...
IDE_Morph.prototype.toggleCameraSupport = function() {
  CamSnapshotDialogMorph.prototype.enableCamera = !CamSnapshotDialogMorph
...
IDE_Morph.prototype.stopAllScripts = function() {
  if (this.stage.enableCustomHatBlocks) {
    this.stage.threads.pauseCustomHatBlocks = !this.stage.threads
...
IDE_Morph.prototype.selectSprite = function(sprite) {
  ...
  if (
    detect(this.world().children, function(morph) {
      return (
        morph instanceof BlockEditorMorph || morph instanceof BlockDialogMorph
      );
    })
  ) {
    return;
...
IDE_Morph.prototype.removeSprite = function(sprite) {
  ...
  this.fixLayout();
  this.currentSprite =
    detect(this.stage.children, function(morph) {
...
IDE_Morph.prototype.newSoundName = function(name) {
  ...
  return this.newName(
    name || lastSound.name,
    this.currentSprite.sounds.asArray().map(function(eachSound) {
...
IDE_Morph.prototype.snapMenu = function() {
  ...
  menu.addLine();
  menu.addItem('Reference manual', function() {
...
IDE_Morph.prototype.cloudMenu = function() {
  ...
  if (this.hasCloudProject()) {
    menu.addLine();
    menu.addItem('Open in Community Site', function() {
...
IDE_Morph.prototype.settingsMenu = function() {
  ...
  addPreference(
    'Log pen vectors',
    function() {
      StageMorph.prototype.enablePenLogging = !StageMorph.prototype
        .enablePenLogging;
    },
  ...
  addPreference(
    ...
    function() {
      BooleanSlotMorph.prototype.isTernary = !BooleanSlotMorph.prototype
        .isTernary;
    },
  ...
  addPreference(
    'Cache Inputs',
    function() {
      BlockMorph.prototype.isCachingInputs = !BlockMorph.prototype
        .isCachingInputs;
    },
  ...
  addPreference(
    'Nested auto-wrapping',
    function() {
      ScriptsMorph.prototype.enableNestedAutoWrapping = !ScriptsMorph.prototype
        .enableNestedAutoWrapping;
  ...
  addPreference(
    'Sprite Nesting',
    function() {
      SpriteMorph.prototype.enableNesting = !SpriteMorph.prototype
        .enableNesting;
    },
  ...
  addPreference(
    'First-Class Sprites',
    function() {
      SpriteMorph.prototype.enableFirstClass = !SpriteMorph.prototype
        .enableFirstClass;
  ...
  addPreference(
    'Keyboard Editing',
    function() {
      ScriptsMorph.prototype.enableKeyboard = !ScriptsMorph.prototype
        .enableKeyboard;
  ...
  addPreference(
    'Flat line ends',
    function() {
      SpriteMorph.prototype.useFlatLineEnds = !SpriteMorph.prototype
        .useFlatLineEnds;
    },
  ...
  addPreference(
    ...
    function() {
      StageMorph.prototype.enableCodeMapping = !StageMorph.prototype
        .enableCodeMapping;
  ...
  addPreference(
    'Inheritance support',
    function() {
      StageMorph.prototype.enableInheritance = !StageMorph.prototype
        .enableInheritance;
      myself.currentSprite.blocksCache.variables = null;
      myself.currentSprite.paletteCache.variables = null;
      myself.refreshPalette();
  ...
  addPreference(
    ...
    function() {
      StageMorph.prototype.enableSublistIDs = !StageMorph.prototype
        .enableSublistIDs;
    },
  ...
  addPreference(
    ...
    function() {
      RingReporterSlotMorph.prototype.enableCommandDrops = !RingReporterSlotMorph
        .prototype.enableCommandDrops;
    },
...
IDE_Morph.prototype.projectMenu = function() {
  ...
  menu.addItem(
    shiftClicked ? 'Export project as plain text...' : 'Export project...',
    function() {
      if (myself.projectName) {
        myself.exportProject(myself.projectName, shiftClicked);
      } else {
...
IDE_Morph.prototype.parseResourceFile = function(text) {
  ...
  text
    ...
    .forEach(function(line) {
      parts = line.split('\t').map(function(str) {
        return str.trim();
      });
...
IDE_Morph.prototype.importMedia = function(folderName) {
  ...
  this.getMediaList(folderName, function(items) {
    msg.destroy();
...
IDE_Morph.prototype.popupMediaImportDialog = function(folderName, items) {
  ...
  items.forEach(function(item) {
    ...
    if (isSound) {
      ...
      myself.getURL(url, function(txt) {
        img.src = 'data:image/svg+xml;base64,' + window.btoa(txt);
      });
    } else {
      img.onload = function() {
...
IDE_Morph.prototype.aboutSnap = function() {
  ...
  translatorsBtn = dlg.addButton(function() {
  ...
  btn2.hide();
  licenseBtn = dlg.addButton(function() {
...
IDE_Morph.prototype.exportGlobalBlocks = function() {
  if (this.stage.globalBlocks.length > 0) {
    new BlockExportDialogMorph(this.serializer, this.stage.globalBlocks).popUp(
      this.world()
    );
  } else {
    this.inform(
...
IDE_Morph.prototype.removeUnusedBlocks = function() {
  ...
  if (unused.length > 0) {
    new BlockRemovalDialogMorph(unused, this.stage).popUp(this.world());
  } else {
    this.inform(
...
IDE_Morph.prototype.exportProjectSummary = function(useDropShadows) {
  ...
  notes.asArray().forEach(function(paragraph) {
    add(paragraph);
  });
...
IDE_Morph.prototype.toggleDynamicInputLabels = function() {
  var projectData;
  SyntaxElementMorph.prototype.dynamicInputLabels = !SyntaxElementMorph
    .prototype.dynamicInputLabels;
  if (Process.prototype.isCatchingErrors) {
    try {
      projectData = this.serializer.serialize(this.stage);
    } catch (err) {
...
IDE_Morph.prototype.toggleLongFormInputDialog = function() {
  InputSlotDialogMorph.prototype.isLaunchingExpanded = !InputSlotDialogMorph
...
IDE_Morph.prototype.togglePlainPrototypeLabels = function() {
  BlockLabelPlaceHolderMorph.prototype.plainLabel = !BlockLabelPlaceHolderMorph
    .prototype.plainLabel;
...
IDE_Morph.prototype.togglePreferEmptySlotDrops = function() {
  ScriptsMorph.prototype.isPreferringEmptySlots = !ScriptsMorph.prototype
    .isPreferringEmptySlots;
};
...
IDE_Morph.prototype.toggleSliderExecute = function() {
  ArgMorph.prototype.executeOnSliderEdit = !ArgMorph.prototype
    .executeOnSliderEdit;
};
...
IDE_Morph.prototype.microphoneMenu = function() {
  ...
  if (microphone.isReady) {
    menu.addItem('\u2611 ' + localize('Microphone'), function() {
      microphone.stop();
    });
    menu.addLine();
  }
  resolutions.forEach(function(res, i) {
    menu.addItem(
      (microphone.resolution === i + 1 ? '\u2713 ' : '    ') + localize(res),
      function() {
  ...
  function zoom() {
    myself.step = function() {
      ...
      if (delta.abs().lt(new Point(5, 5))) {
        ...
        StageMorph.prototype.dimensions = StageMorph.prototype.dimensions.add(
          delta
        );
      }
...
IDE_Morph.prototype.buildProjectRequest = function() {
  var xml = this.serializer.serialize(this.stage),
    thumbnail = normalizeCanvas(
      this.stage.thumbnail(SnapSerializer.prototype.thumbnailSize)
    ).toDataURL(),
    body;
  ...
  body = {
    ...
    media: this.hasChangedMedia
      ? this.serializer.mediaXML(this.projectName)
      : null,
    thumbnail: thumbnail,
    ...
    if (async) {
      request.onreadystatechange = function() {
        if (request.readyState === 4) {
          if (request[rsp]) {
            callback.call(myself, request[rsp]);
          } else {
            throw new Error('unable to retrieve ' + url);
          }
        }
...
ProjectDialogMorph.prototype.buildFilterField = function() {
  ...
  this.filterField.reactToInput = function(evt) {
    ...
    myself.listField.elements = myself.projectList.filter(function(aProject) {
    ...
    this.listField.action = function(item) {
      ...
      if (myself.task === 'open') {
        ...
        if (src) {
          ...
          myself.preview.texture = xml.childNamed('thumbnail').contents || null;
...
ProjectDialogMorph.prototype.installCloudProjectList = function(pl) {
  ...
  this.projectList.sort(function(x, y) {
    return x.projectname.toLowerCase() < y.projectname.toLowerCase() ? -1 : 1;
  });
  ...
  this.listField = new ListMorph(
    ...
    [
      ...
      [
        'bold',
        function(proj) {
          return proj.ispublic;
        }
      ],
      [
        'italic',
        function(proj) {
          return proj.ispublished;
        }
      ]
    ],
    function() {
...
ProjectDialogMorph.prototype.saveProject = function() {
  ...
  if (name) {
    if (this.source === 'cloud') {
      if (
        detect(this.projectList, function(item) {
...
ProjectRecoveryDialogMorph.prototype.buildListField = function() {
  ...
  this.listField.action = function(item) {
    ...
    version = detect(myself.versions, function(version) {
  ...
  this.ide.cloud.getProjectVersionMetadata(
    ...
    function(versions) {
      ...
      myself.listField.elements = myself.versions.map(function(version) {
...
ProjectRecoveryDialogMorph.prototype.cancel = function() {
  ...
  this.browser.listField.select(
    detect(this.browser.projectList, function(item) {
...
ProjectRecoveryDialogMorph.prototype.recoverProject = function() {
  var lastupdated = this.listField.selected,
    version = detect(this.versions, function(version) {
...
LibraryImportDialogMorph.prototype.installLibrariesList = function() {
  ...
  this.listField.action = function(item) {
    ...
    if (myself.hasCached(item.fileName)) {
      ...
      myself.showMessage(localize('Loading') + '\n' + localize(item.name));
      myself.ide.getURL(
...
LibraryImportDialogMorph.prototype.importLibrary = function() {
  ...
  if (this.hasCached(selectedLibrary)) {
    ...
    ide.getURL(ide.resourceURL('libraries', selectedLibrary), function(
      libraryText
    ) {
...
LibraryImportDialogMorph.prototype.displayBlocks = function(libraryKey) {
  ...
  SpriteMorph.prototype.categories.forEach(function(category) {
    blocksList.forEach(function(definition) {
      ...
      blockContainer.setExtent(new Point(blockImage.width, blockImage.height));
...
SpriteIconMorph.prototype.userMenu = function() {
  ...
  if (this.object instanceof StageMorph) {
    menu.addItem(
      ...
      function() {
        var ide = myself.parentThatIsA(IDE_Morph);
        ide.saveCanvasAs(myself.object.fullImageClassic(), this.object.name);
      },
    ...
    if (this.object.trailsLog.length) {
      menu.addItem(
        'svg...',
        function() {
          myself.object.exportTrailsLogAsSVG();
        },
...
SpriteIconMorph.prototype.createBackgrounds = function() {
  ...
  if (this.template) {
    // take the backgrounds images from the template
...
WardrobeMorph.prototype.updateList = function() {
  ...
  if (CamSnapshotDialogMorph.prototype.enableCamera) {
    ...
    document.addEventListener('cameraDisabled', function() {
      cambutton.disable();
      cambutton.hint = CamSnapshotDialogMorph.prototype.notSupportedMessage;
    });
  }
...
WardrobeMorph.prototype.newFromCam = function() {
  ...
  camDialog = new CamSnapshotDialogMorph(ide, sprite, nop, function(costume) {
    sprite.addCostume(costume);
    sprite.wearCostume(costume);
    myself.updateList();
  });
...
StageHandleMorph.prototype.drawNew = function() {
  ...
  this.drawOnCanvas(this.normalImage, this.color);
  this.drawOnCanvas(
    this.highlightImage,
    MorphicPreferences.isFlat
...
PaletteHandleMorph.prototype.drawNew = StageHandleMorph.prototype.drawNew;
